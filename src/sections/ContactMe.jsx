...
const ContactMe = () => {
  return (
    <main className="bg-gray-200 flex md:items-center md:justify-center py-16 px-4">
      <div id="contactMe" className="max-w-5xl mx-auto w-full bg-white flex flex-col md:flex-row 
        ...
        <div className="w-full md:w-2/5 flex flex-col items-center space-y-6 md:space-y-8">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex text-gray-600 space-x-3">
              ...
              <a className="hover:border-gray-600 border-2 border-gray-400 duration-500 rounded-full w-[50px] h-[50px] flex justify-center items-center" title="Facebook" href="https://www.facebook.com/profile.php?id=100010069958213" target="_blank" rel="noopener noreferrer">
                <FaFacebook className="text-2xl" />
              </a>
              <a className="hover:border-gray-600 border-2 border-gray-400 duration-500 rounded-full w-[50px] h-[50px] flex justify-center items-center" title="Instagram" href="https://www.instagram.com/tayseersuliman?igshMWd2puNjRpOA" target="_blank" rel="noopener noreferrer">
